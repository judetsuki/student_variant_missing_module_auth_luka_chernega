...
class Order(models.Model):
    ...
    pickup_point = models.ForeignKey('PickupPoint', on_delete=models.CASCADE,verbose_name='Адрес пункта доставки')
...
class OrderStatus(models.Model):    
    ...
    name = models.CharField(choices=STATUS_CHOICES,max_length=30,verbose_name='Статус заказа')
